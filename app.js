$(document).ready(function() {
    ...
    function loadMain(path, skipCache) {
        ...
        var url = 'load_page.php?page=' + path + '&username=' + getUsernameFromPath(path) + '&hashtag=' + getHashtagFromPath(path);
        $.ajax({
            url: url,
            type: 'GET',
    ...
    function updateURL(path) {
        var newURL = root + path; // Updated URL format

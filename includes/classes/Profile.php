<?php
    ...
    class Profile extends DB {
        ...
        public function getProfile() {
            ...
            $return = '<div class="div m1 radius1 profile" data-aos="fade-up" data-aos-offset="200">

                        <div class="profile-top">

                            <div class="profile-image-2" openModal("img", , true)><img src="'.$this->user->getImage_2().'"></div>

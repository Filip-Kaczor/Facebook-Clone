<?php
    ...
    public function login($un, $pw) {
        ...
        $query = $this->con->prepare("SELECT * FROM users WHERE (username = :un OR email = :un) AND password = :pw");
    ...
    private function insertUserDetails($un, $em, $pw) {
        ...
        $result = mysqli_query($this->con, "INSERT INTO users VALUES ('', '', '', '', '', '$date', '$un', '$em', '$encryptedPw', '$profilePic', '$date', '', '', '')");
